...
const MapHome = () => {
  ...
  let activeLines = [];
  if (activeTab === 'CAR' && carRoute) activeLines = carRoute.lines;
  if (activeTab === 'TRANSIT') activeLines = transitLines;
  if (activeTab === 'WALK' && walkRoute) activeLines = walkRoute.lines;
